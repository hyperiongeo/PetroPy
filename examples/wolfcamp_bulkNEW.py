...
raw_las_folder = r'examples/wfmp_raw_las/'
...
for las_file in las_files:
    ...
    # save changes to edited folder in case reprocessing after editing is needed
...
edited_file_folder = r'examples/wfmp_edited_las/'
...
# define curves to use in electofacies module
