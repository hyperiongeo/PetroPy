...
las_file_path = 'examples/42303347740000_2.las'
...
# since path is not specified, load default  csv file included with petropy
...
# define pay flogs as list of tuples for (curve, value)
...
# calculate electrofacies for the defined logs over the specified formations               #
...
# calculate stats over specified formation and save to csv file wfmp_statistics.csv
# update the line if the well, formation is already included in the csv file
...
# scale height of viewer to top and bottom of calculated values
...
# create LogViewer with the default full_oil template included in petropy

viewer = ptr.LogViewer(log, top = top, height = height,
                        template_defaults = 'full_oil')

# set viewer to 17x11 inches size for use in PowerPoint or printing to larger paper
